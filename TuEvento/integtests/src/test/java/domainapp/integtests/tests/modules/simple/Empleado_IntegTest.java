...
public class Empleado_IntegTest extends DomainAppIntegTest {
    ...
    Personal simpleObject;

    @Before
    public void setUp() throws Exception {
        // given
        RecreatePersonalServicio fs = new RecreatePersonalServicio().setNumber(1);
    ...
    public static class Name extends Empleado_IntegTest {
        ...
        public void accessible() throws Exception {
            // when
            final String name = wrap(simpleObject).getNombre();

            // then
            assertThat(name).isEqualTo(simpleObject.getNombre());
        }
        ...
        public void not_editable() throws Exception {
            ...
            // when
            wrap(simpleObject).setNombre("new name");
        }
    ...
    public static class UpdateName extends Empleado_IntegTest {
        ...
        public void can_be_updated_directly() throws Exception {
            ...
            // then
            assertThat(wrap(simpleObject).getNombre()).isEqualTo("new name");
        }
